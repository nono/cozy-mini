...
var _nono$cozy_mini$OnEnter$onEnter = function (message) {
	return A2(
		_elm_lang$html$Html_Events$on,
		'keydown',
		A2(
			_elm_lang$core$Json_Decode$andThen,
			_nono$cozy_mini$OnEnter$is13(message),
		...
		return A2(
			...
			},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('Pas de résultats'),
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			});
...
var _nono$cozy_mini$Main$UpdateQuery = function (a) {
	return {ctor: 'UpdateQuery', _0: a};
};
var _nono$cozy_mini$Main$query = function (model) {
	return A2(
		_elm_lang$html$Html$input,
		{
			...
			_1: {
				...
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html_Events$onInput(_nono$cozy_mini$Main$UpdateQuery),
					_1: {
						ctor: '::',
						_0: _nono$cozy_mini$OnEnter$onEnter(_nono$cozy_mini$Main$Search),
						_1: {ctor: '[]'}
					}
				}
			}
...
var _nono$cozy_mini$Main$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
		...
		},
		{
			...
			_0: A2(
				...
				},
				{
					...
					_1: {
						ctor: '::',
						_0: _nono$cozy_mini$Main$query(model),
						_1: {
							ctor: '::',
							_0: A2(
								_elm_lang$html$Html$div,
			...
			_1: {
				ctor: '::',
				_0: _nono$cozy_mini$Main$sidebar(model),
				_1: {
					ctor: '::',
					_0: _nono$cozy_mini$Main$results(model),
					_1: {ctor: '[]'}
				}
			}
		});
};
var _nono$cozy_mini$Main$main = _elm_lang$html$Html$program(
	{
		view: _nono$cozy_mini$Main$view,
		init: _nono$cozy_mini$Main$init,
		update: _nono$cozy_mini$Main$update,
		subscriptions: _elm_lang$core$Basics$always(_elm_lang$core$Platform_Sub$none)
	})();

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _nono$cozy_mini$Main$main !== 'undefined') {
    _nono$cozy_mini$Main$main(Elm['Main'], 'Main', undefined);
}
